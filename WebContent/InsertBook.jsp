...
<div class="row">
	...
	<ul class="nav nav-tabs">
	  <li class="active"><a href="#book" data-toggle="tab">添加图书</a></li>
	  <li><a href="#author" data-toggle="tab">添加作者</a></li>
	</ul>
	</div>
</div>
  ...
  <div class="tab-pane fade active in" id="book">
	...
	<form action="insert">
		<div class="form-group">
		  ...
		  <input type="text" class="form-control" id="book.ISBN" type="text"  placeholder="请输入ISBN" name="book.ISBN">
		</div>
